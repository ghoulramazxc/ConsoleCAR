...
class Program
{
    static void Main()
    {
        ...
        {
            new Car("Lada", "2109", "EW228VI", "Черный"),
            new Car("Toyota", "Supra", "LW567HY", "Оранжевый"),
            new Car("Mazda", "3", "PO935XX", "Черный")
        };
